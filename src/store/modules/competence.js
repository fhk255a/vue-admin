  ...
  state:{
    ...
    roleList:[
      ...
      },
      {
        ...
        menu:["/h5","/h5/list","/h5/details","/product", "/product/list", "/product/details", "/product/shop", "/order", "/order/list", "/order/details", "/competence", "/competence/user", "/competence/role", "/competence/menu", "/competence/resource"],
        remark:'一看就很厉害',
